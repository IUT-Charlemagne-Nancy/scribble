...
public class DessinFigures extends JPanel {
	...
	/**
	 * Paramètre privée permettant de sauvegarder la position X du curseur
	 */
	private int lastX;

	/**
	 * Paramètre privée permettant de sauvegarder la position y du curseur
	 */
	private int lastY;

	/**
	 * Création d'un ManipulateurFormes pour pouvoir désactiver son listener
	 * facilement
	 */
	private ManipulateurFormes manipul;

	/**
	 * Paramètre privée permettant de définir la couleur des dessins
	 */
	...
	/**
	 * Indice de la figure actuellement selectionnée (-1 si aucune figure
	 * selectionnee)
	 */
	private int sel;
	 ...
	 * des figures à la souris (ajout du listener)
	 * 
	 * @param fc
	 *            -forme à construire point par point à la souris
	 */
	...
	/**
	 * Methode qui applique à la couleur de DessinFigures une nouvelles couleur
	 * 
	 * @param a
	 *            nouvelle couleur
	 */
	...
	public class ManipulateurFormes extends java.lang.Object implements
		...
		/**
		 * Attribut privé qui permet de sauvegarder les positions en x du curseur
		 */
		private int last_x;

		/**
		 * Attribut privé qui permet de sauvegarder les positions en y du curseur
		 */
		private int last_y;

		/**
		 * Methode qui permet de deplacer la figure avec le clic gauche, et deplacer les carrés rouge avec le clic droit
		 */
		@Override
		public void mouseDragged(MouseEvent e) {
